...
function fetchWeather(lat, lon, cb) {
  ...
  .then(function(d) {
    ...
    if (wc >= 80)      { icon = "\u26C8\uFE0F"; cond = "Thunderstorm"; warn = "\u26A0\uFE0F Severe weather \u2014 avoid driving"; }
    else if (wc >= 70) { icon = "\uD83C\uDF28\uFE0F"; cond = "Snow/Freezing"; warn = "\u26A0\uFE0F Icy conditions"; }
    else if (wc >= 61) { icon = "\uD83C\uDF27\uFE0F"; cond = "Heavy rain"; warn = "\u26A0\uFE0F Low visibility"; }
    else if (wc >= 51) { icon = "\uD83C\uDF26\uFE0F"; cond = "Light rain"; warn = "Drive carefully"; }
    else if (wc >= 45) { icon = "\uD83C\uDF2B\uFE0F"; cond = "Fog"; warn = "\u26A0\uFE0F Reduce speed in fog"; }
...
function wxHtml(w) {
  ...
  h += '<span class="wx-icon">' + w.icon + '</span>';
