...
function startNav() {
  ...
  /* Stop the ambient live-location watcher — nav.js uses its own higher-cadence
     watcher below, and two simultaneous watchers burn battery for no benefit. */
...
function stopNav() {
  ...
  /* Nav's watcher is done — bring the ambient "you are here" arrow back. */
